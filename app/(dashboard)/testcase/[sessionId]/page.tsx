...
export default function ConversationTestCasePage() {
  ...
  const handleSend = async () => {
    ...
    try {
      const data: ConversationTestCaseResult = await conversationTestCase(
        sessionId,
        content,
      )
      ...
      <div className="flex items-center gap-3 pb-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg font-semibold flex items-center gap-2">
            ...
            Test Case Generator — Hội thoại
          </h1>
          <p className="text-xs text-muted-foreground truncate">
            Gửi code hoặc hỏi thêm để sinh test cases chuyên sâu
          </p>
        </div>
      </div>
          ...
          {messages.map((msg, i) => (
            <div key={i} className="flex gap-3">
              ...
              <div className="flex-1 min-w-0 space-y-3">
                ...
                {msg.testCases && (
                  <div className="mt-2">
                    <TestCaseResultPanel result={msg.testCases} />
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="border-t pt-4 pb-1 space-y-3">
        ...
        >
          ...
          <TabsContent value="text" className="mt-2">
            <Textarea
              placeholder="Hỏi thêm hoặc yêu cầu sinh thêm test cases…"
              value={text}
